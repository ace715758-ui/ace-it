...
export default function PracticeWeakAreasClient({
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto pb-12">
      {/* Header Banner (Inspired by user design - Seamless Background Integration) */}
      <div className="relative rounded-3xl p-6 sm:p-9 lg:p-10 overflow-hidden bg-[#070b24] text-white shadow-2xl border border-indigo-500/20">
